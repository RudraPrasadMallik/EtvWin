...
public class ExcelUtility {
    ...
    public void setExcelFile(String sheetPath, String sheetName) throws Exception {
        try {
            ...
            excelWorkbook = new XSSFWorkbook("excelFile");  // Fixed issue: correct the file path reference
    ...
    public String getCellData(int rowNumb, int colNumb) throws Exception {
        try {
            ...
            if (cell.getCellType() == CellType.NUMERIC) {  // Updated to CellType enum
                cell.setCellType(CellType.STRING);  // Updated to CellType enum
            }
    ...
    public Map<String, String> getData(String testCaseName, String sheetPath, String sheetName) {
        ...
        try {
            ...
            for (int i = 0; i < columnCount; i++) {
                ...
                if (cell != null && cell.getCellType() == CellType.NUMERIC) {  // Updated to CellType enum
                    cell.setCellType(CellType.STRING);  // Updated to CellType enum
                }
                if (cell != null) {
